...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/bin/mnld', 'vendor/lib64/liboplus_mtkcam_lightsensorprovider.so', 'vendor/lib64/mt6983/libaalservice.so'): blob_fixup()
    ...
    'vendor/lib64/hw/mt6983/vendor.mediatek.hardware.pq@2.15-impl.so': blob_fixup()
        ...
        .replace_needed('libutils.so', 'libutils-v32.so'),
    ('vendor/lib64/mt6983/lib3a.awbsync.so', 'vendor/lib64/mt6983/lib3a.flash.so', 'vendor/lib64/mt6983/lib3a.sensors.color.so', 'vendor/lib64/mt6983/lib3a.sensors.flicker.so', 'vendor/lib64/lib3a.ae.pipe.so'): blob_fixup()
    ...
    ('vendor/oneplus/vitamin/proprietary/odm/bin/touchDaemon', 'odm/bin/hw/vendor.oplus.hardware.biometrics.fingerprint@2.1-service_uff', 'vendor/lib64/hw/audio.primary.mediatek.so', 'vendor/lib64/librt_extamp_intf.so', 'vendor/lib64/hw/mt6983/vendor.mediatek.hardware.pq@2.15-impl.so',): blob_fixup()
